...
There is one common case, however, where \code{Get} and \code{Set} do incur a
...
The disadvantage of using \code{Value} over \code{Get} and \code{Set} is that
is cannot support image adaptors. Whenever possible, use \code{Get} and
