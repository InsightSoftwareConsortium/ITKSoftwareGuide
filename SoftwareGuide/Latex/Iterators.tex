...
step, the result of one \code{++} opesration.}
...
pixel indicies are referenced as offsets from the center index.  The pixel
...
\index{NeighborhoodIterator!OverideBoundaryCondition()}.
