...
\item \textbf{\code{itk::Offset GetOffset(unsigned int i)}} 
\item \textbf{\code{unsigned long GetNeighborhoodIndex(itk::Offset)}} 

\item \textbf{\code{std::slice GetSlice(unsigned int n)}} 

\item \textbf{\code{const ImageType *GetImagePointer()}} 
\item \textbf{\code{unsigned long GetSize()}}
\item \textbf{\code{itk::Size GetRadius()}}
...
\input{Neighborhooditerator2.tex}
\input{Neighborhooditerator3.tex}
\input{Neighborhooditerator4.tex}
\input{Neighborhooditerator5.tex}
\input{Neighborhooditerator6.tex}
...
% DIFFERNCES IN THE REST OF THE API


\input{ShapedNeighborhoodIterator1.tex}
\input{ShapedNeighborhoodIterator2.tex}
