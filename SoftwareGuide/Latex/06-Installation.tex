...
\begin{itemize}
\item GCC 4.x
\item Visual Studio  7.1 (Until 2012), 8 SP 1 (Until 2015), 9 (Until 2018), 10 (Until 2020)
\item Intel Compiler Suite 11.x, 12.x
\item Darwin-c++-4.2 PPC (Until 2015), x86\_64
\item SunOS-CC amd64, i386, amd64
\item Win32-mingw-gcc-4.5
\end{itemize}

While not officially supported, CLang beta 3.3 \& later
(\url{http://clang.llvm.org/}) have been reported to work as well.
...
use of CMake (\url{www.cmake.org}), a cross-platform, open-source build system.
...
The mininum version of CMake has been evolving along with the version of
ITK. For example, the current latest version of ITK (4.5) requires the minimum
CMake version to be 2.8.7. You can download binary versions for most of the popular
platforms including Windows, Solaris, HP, Mac and Linux. Alternatively you can
download the source code and build CMake on your system. Follow the
instructions in the CMake web page for downloading and installing the software.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{ITK_CMake_GUI_Ubuntu.png}
\includegraphics[width=0.8\textwidth]{ITK_CMake_GUI_Windows.png}
...
system. If you decide to enable testing as part of the normal build process,
