...
the Tcl and Python interpreted languages. However, as a user you must
...
\code{Insight} module; documentation, tutuorials, and material related to the
...
\code{InsightApplications} module should only be downloaded and compile once
