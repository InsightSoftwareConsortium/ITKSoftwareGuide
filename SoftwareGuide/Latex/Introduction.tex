...
\footnote{\url{http://www.itk.org/HTML/GettingStarted.txt}} document 
...
move inside this directory \code{Insight} and type:
\begin{verbatim}
cvs update -d -P
\end{verbatim}

Once you obtain the software you are ready to configure and compile it (see
\ref{sec:CMakeforITK} on page \pageref{\ref{sec:CMakeforITK}). First,
