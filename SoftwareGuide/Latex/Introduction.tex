...
doumentation pages (\code{http://www.itk.org/HTML/Documentation.htm})) and
...
Besides this text and The \emph{Insight Toolkit} text (see the next section for more information), there are other documentation resources that you should be aware of.
...
For more information about the \emph{Insight Toolkit} we recommend the following resources.
