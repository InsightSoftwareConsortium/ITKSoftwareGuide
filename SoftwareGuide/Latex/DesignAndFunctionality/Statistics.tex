...
algorithm also has its weighted version (see Section~\ref{sec:WeightedMeanCovariance}).
The weighted versions are used in the expectation-maximization parameter estimation process.
...
measures that have some relevance in terms of Information Theory~\cite{Shannon1948,Shannon1949,Kullback1997}.
