...
To better understand the IO architecture, please refer to
Figures~\ref{fig:ImageIOCollaborationDiagram},~\ref{fig:ImageIOFactoriesUseCases},
and~\ref{fig:ImageIOFactoriesClassDiagram}.
