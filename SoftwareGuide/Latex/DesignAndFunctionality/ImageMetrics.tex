...
positions. Details on this mapping are illustrated in Figures~\ref{fig:ImageOverlapIterator}
and~\ref{fig:ImageOverlapInterpolator} assuming
...
in~\ref{sec:MutualInformationMetric}. Details of the implementation may be found in~\cite{Hajnal2001}.
