...
library. The environment for access to the \code{itk} Python module is configured
...
.dll files to your \code{PATH} environmental variable, e.g.
\code{C:\ITK-build\bin\Release}.
