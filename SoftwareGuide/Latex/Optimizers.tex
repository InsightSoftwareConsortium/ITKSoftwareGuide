...
The types of \doxygen{SingleValuedNonLinearOptimizer}s currently available
in ITK are:

\index{itk::AmoebOptimizer}
...
(\doxygen{ConjugateGradientOptimizer}). Also an adaptor to an optimizer in
\code{vnl}.
...
A specialized version of \doxygen{GradientDescentOptimizer} for
\doxygen{QuaternionRigidTransform} parameters, where the parameters representing
...
\doxygen{RegularStepGradientDescentOptimizer} for \doxygen{VersorTransform}
