...
by extracting the zero level set $\Gamma(\bf(X),t) = \{\psi{\bf{X},t) = 0\}$.
The main advantages of using levels sets is that arbitrarily complex shapes can be modeled
and topologically changes such as mergeing and splitting is handled implicitly.
