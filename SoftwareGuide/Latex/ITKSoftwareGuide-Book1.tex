...
\input{Introduction/Installation.tex}


\part{Architecture}

\input{Architecture/SystemOverview.tex}
\input{Architecture/DataRepresentation.tex}
\input{Architecture/SpatialObjects.tex}
\input{Architecture/Iterators.tex}
\input{Architecture/ImageAdaptors.tex}


\part{Development Guidelines}

\input{DevelopmentGuidelines/WriteAFilter.tex}
\input{DevelopmentGuidelines/CreateAModule.tex}
