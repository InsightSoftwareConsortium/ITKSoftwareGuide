...
\midrule
\midrule
\textbf{Mangling} & ITKM\_B & B \\
\textbf{C++ Type} & ITKT\_B & bool \\
\midrule
\textbf{Mangling} & ITKM\_UC & UC \\
\textbf{C++ Type} & ITKT\_UC & unsigned char \\
\midrule
\textbf{Mangling} & ITKM\_US & US \\
\textbf{C++ Type} & ITKT\_US & unsigned short \\
\midrule
\textbf{Mangling} & ITKM\_UI & UI \\
\textbf{C++ Type} & ITKT\_UI & unsigned integer \\
\midrule
\textbf{Mangling} & ITKM\_UL & UL \\
\textbf{C++ Type} & ITKT\_UL & unsigned long \\
\midrule
\textbf{Mangling} & ITKM\_ULL & ULL \\
\textbf{C++ Type} & ITKT\_ULL & unsigned long long \\
\midrule
\textbf{Mangling} & ITKM\_SC & SC \\
\textbf{C++ Type} & ITKT\_SC & signed char \\
\midrule
\textbf{Mangling} & ITKM\_SS & SS \\
\textbf{C++ Type} & ITKT\_SS & signed short \\
\midrule
\textbf{Mangling} & ITKM\_SI & SI \\
\textbf{C++ Type} & ITKT\_SI & signed integer \\
\midrule
\textbf{Mangling} & ITKM\_SL & SL \\
\textbf{C++ Type} & ITKT\_SL & signed long \\
\midrule
\textbf{Mangling} & ITKM\_SLL & SLL \\
\textbf{C++ Type} & ITKT\_SLL & signed long long \\
\midrule
\textbf{Mangling} & ITKM\_F & F \\
\textbf{C++ Type} & ITKT\_F & float \\
\midrule
\textbf{Mangling} & ITKM\_D & D \\
\textbf{C++ Type} & ITKT\_D & double \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
\midrule
\textbf{Mangling} & ITKM\_C\$\{type\} & C\$\{type\} \\
\textbf{C++ Type} & ITKT\_C\$\{type\} & std::complex\textless \$\{type\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_A\$\{type\} & A\$\{type\} \\
\textbf{C++ Type} & ITKT\_A\$\{type\} & itk::Array\textless \$\{type\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_FA\$\{ITKM\_\$\{type\}\}\$\{dim\} & FA\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_FA\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::FixedArray\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_RGB\$\{dim\} & RGB\$\{dim\} \\
\textbf{C++ Type} & ITKT\_RGB\$\{dim\} & itk::RGBPixel\textless \$\{dim\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_RGBA\$\{dim\} & RGBA\$\{dim\} \\
\textbf{C++ Type} & ITKT\_RGBA\$\{dim\} & itk::RGBAPixel\textless \$\{dim\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_V\$\{ITKM\_\$\{type\}\}\$\{dim\} & V\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_V\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::Vector\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_CV\$\{ITKM\_\$\{type\}\}\$\{dim\} & CV\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_CV\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::CovariantVector\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_VLV\$\{ITKM\_\$\{type\}\}\$\{dim\} & VLV\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_VLV\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::VariableLengthVector\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_SSRT\$\{ITKM\_\$\{type\}\}\$\{dim\} & SSRT\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_SSRT\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::SymmetricSecondRankTensor\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
\midrule
\textbf{Mangling} & ITKM\_O\$\{dim\} & O\$\{dim\} \\
\textbf{C++ Type} & ITKT\_O\$\{dim\} & itk::Offset\textless \$\{dim\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_CI\$\{ITKM\_\$\{type\}\}\$\{dim\} & CI\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_CI\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::ContinuousIndex\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_P\$\{ITKM\_\$\{type\}\}\$\{dim\} & P\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_P\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::Point\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_I\$\{ITKM\_\$\{type\}\}\$\{dim\} & I\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_I\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::Image\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_VI\$\{ITKM\_\$\{type\}\}\$\{dim\} & VI\$\{ITKM\_\$\{type\}\}\$\{dim\} \\
\textbf{C++ Type} & ITKT\_VI\$\{ITKM\_\$\{type\}\}\$\{dim\} & itk::VectorImage\textless \$\{ITKT\_\$\{type\}\}, \$\{dim\} \textgreater \\
\midrule
\textbf{Mangling} & ITKM\_SO\$\{dim\} & SO\$\{dim\} \\
\textbf{C++ Type} & ITKT\_SO\$\{dim\} & itk::SpatialObject\textless \$\{dim\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_SE\$\{dim\} & SE\$\{dim\} \\
\textbf{C++ Type} & ITKT\_SE\$\{dim\} & itk::FlatStructuringElement\textless \$\{dim\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_H\$\{ITKM\_\$\{type\}\} & H\$\{ITKM\_\$\{type\}\} \\
\textbf{C++ Type} & ITKT\_H\$\{ITKM\_\$\{type\}\} & itk::Statistics::Histogram\textless \$\{ITKT\$\{type\}\} \textgreater\\
\midrule
\textbf{Mangling} & ITKM\_ST & Depends on platform \\
\textbf{C++ Type} & ITKT\_ST & itk::SizeValueType \\
\midrule
\textbf{Mangling} & ITKM\_IT & Depends on platform \\
\textbf{C++ Type} & ITKT\_IT & itk::IdentifierType \\
\midrule
\textbf{Mangling} & ITKM\_OT & Depends on platform\\
\textbf{C++ Type} & ITKT\_OT & itk::OffsetValueType \\
\bottomrule
\end{tabular}
\end{center}
...
being accessible as \code{itk.MathematicalMorphologyEnums.Algorithm}, and its
...
\code{ITKVideoBridgeOpenCV}, and publicly link to the OpenCV libraries.
