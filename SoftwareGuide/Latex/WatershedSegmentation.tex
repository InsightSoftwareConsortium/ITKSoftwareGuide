...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{watersheds.eps}
...
Figures~\ref{fig:colorsegment1}--~\ref{fig:colorsegment3}
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{color_edges5.eps}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{spine1.eps}
\includegraphics[width=0.4\textwidth]{spine2.eps}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{arm1.eps}
\includegraphics[width=0.4\textwidth]{arm2.eps}
\caption{
Insets from the segmentation of the color image shown in 
Figure~\protect\ref{fig:colorsegment1} at two different levels of 
...
\begin{figure}
\centering
\includegraphics[width=0.80\textwidth]{PreprocessWatersheds.eps}
...
\begin{figure}
\centering
\includegraphics[width=0.80\textwidth]{segmentationsoftware1.eps}
