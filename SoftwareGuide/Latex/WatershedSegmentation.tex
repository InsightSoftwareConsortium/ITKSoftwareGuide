...
\itkcaption{The construction of the Insight watersheds filter.}
...
%\itkcaption{A slice from a segmentation of Visible Female cryosection data.
...
%\itkcaption{A surface rendering (right) of four anatomical structures in the Visible
