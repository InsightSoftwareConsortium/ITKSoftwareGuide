...
\begin{figure} \center
\includegraphics[width=8cm]{DeformableRegistration1CheckerboardBefore.eps}
\includegraphics[width=8cm]{DeformableRegistration1CheckerboardAfter.eps}
\caption{Checkerboard comparisons before and after deformable registration.}
\label{fig:DeformableRegistration1Output}
\end{figure}

Figure \ref{fig:DeformableRegistration1Output} presents the results of the
deformable registration applied to two time-separated slices of a living mouse
dataset. Checkerboard comparisions of the two images are shown before
registration (left) and after registration (right). Both images have been
acquired from the same living mouse capturing two different stages of the
respiratory cycle. The abdominal region is deformed due to tha action of
diaphragm muscles.


This is a documented sample parameter file that can be used with this
