...
do not restrict modification nor distribution of the code, and that does not
...
regions of the code, while from time to time reacomodations of a larger scale
