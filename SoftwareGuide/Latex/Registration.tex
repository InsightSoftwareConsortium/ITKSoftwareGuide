...
and are used for establishing the spatial correspondance between the images.
...
set has a known correspondance to exactly one point in the second set.
\item Two PointSets without known correspondances between the points of one set
...
correspondances between the points make possible to apply a straight forward
