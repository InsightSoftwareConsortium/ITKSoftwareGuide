...
\begin{description}
  ...
  the image.  Via SpatialObjects, mutual information, cross-correlation, and
  boundary-to-image metrics of ITK can be applied without modification to
  perform spatialObject-to-image registration.
  ...
  SpatialObject class hierarchy.  MetaObject IO methods are provided, and
  others are easily defined.
