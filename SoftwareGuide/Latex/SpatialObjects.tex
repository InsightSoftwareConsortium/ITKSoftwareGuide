...
of tubular structures using SpatialObjects. \doxygen{VesselTubeSpatialObject} and 
\doxygen{DTITubeSpatialObject} are currently deriving from this base class.
