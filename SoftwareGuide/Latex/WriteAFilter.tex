...
\begin{figure}
  \par\centering
  \resizebox{5in}{!}{ \includegraphics{DataPipelineOneConnection.eps}} 
  \itkcaption{\label{fig:DataPipeLineOneConnection}Relationship between itk::DataObjects and itk::ProcessObjects }
  \par
\end{figure}
...
\begin{figure}
  ...
  \itkcaption{\label{fig:DataPipeLine}The Data Pipeline}
  \par
\end{figure}
...
\begin{figure}
  ...
  \itkcaption{\label{fig:DataPipeLineUpdate}Sequence of the Data Pipeline updating mechanism}
  \par
\end{figure}
