...
As well as the measure value, gradient-based optimization schemes also
require derivatives of the measure with respect to each transform
parameter. The methods \code{GetDerivatives} and 
\code{GetValueAndDerivatives} can be used to obtained the gradient
information.
