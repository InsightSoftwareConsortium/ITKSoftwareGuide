...
\code{NormalizedCorrelationImageToImageMetric} computes 
pixel-wise cross-correlation and normalize it
...
is limited to images obtained using the same imaging modality. The metric
...
specified by Mattes et al in \cite{Mattes2001}.
