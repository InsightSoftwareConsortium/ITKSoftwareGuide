...
The MeanSquaresImageToImageMetric computes the mean squared pixel-wise difference in intensity
...
The MeanReciprocalSquareDifferenceImageToImageMetric computes pixel-wise differences and adds them 
...
regard, $\lambda$ should be given in intensity units and be associated with the
...
the MattesMutualInformationImageToImageMetric class.
