...
\item mean reciprocal square differences \\ \doxygen{MeanReciprocalSquareDifferenceImageToImageMetric} 
...
\doxygen{MeanReciprocalSquareDifferenceImageToImageMetric} computes pixel-wise differences and adds them 
...
The metric is limited for images of the same image modality.  The
...
The \doxygen{MutualInformationImageToImageMetric} metric computes the mutual
