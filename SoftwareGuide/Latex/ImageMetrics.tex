...
are then added them after passing them through a function $\frac{1}{1+x}$. The
purpose of this metric is to focus the registration on the edges of structures
in the images.  In this way the borders excert larger influence on the result
of the registration than the inside of the homogeneous regions on the image.
