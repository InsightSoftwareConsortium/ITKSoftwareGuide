...
\doxygen{PatternIntensityImageToImageMetric} computes pixel-wise differences and add them 
...
\doxygen{MutualInformationImageToImageMetric} which follows the method specified
