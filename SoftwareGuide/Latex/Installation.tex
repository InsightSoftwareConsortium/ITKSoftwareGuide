...
\begin{figure}[ht]
\centering 
\includegraphics[width=0.9\textwidth]{ccmakeScreenShot.eps}
\includegraphics[width=0.9\textwidth]{CMakeSetupScreenShot.eps}
...
INCLUDE(\$\{USE\_ITK\_FILE\})} loads the \code{UseITK.cmake} file to set
