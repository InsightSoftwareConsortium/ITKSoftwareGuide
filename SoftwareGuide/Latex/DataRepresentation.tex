...
sensitive to color~\cite{Gray2003} and their regions of sensitivity lossely
...
repeated with 24 hours intervals.} receptors are sensitive to the lighthing
conditions that differentiate day from night.  These receptors evolved as a
mechanism for syncronizing the physiology with the time of the day. Cellular
controls for circadian rithms are present in every cell of an organism and are
...
eye, or to the three phosphors found in most computer screeens or to the color
