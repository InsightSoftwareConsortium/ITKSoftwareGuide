...
\begin{itemize}
\item The \code{itkSimpleFuzzyConnectednessScalarImageFilter}, an implementation of the
fuzzy connectedness segmentation of single-channel (grayscale) image.
\item The \code{itkSimpleFuzzyConnectednessRGBImageFilter}, an implementation
of fuzzy connectedness segmentation of a three-channel (RGB) image. 
\end{itemize}

Other classes can be derived from the base class by defining other affinity
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{FuzzyConnectednessClassDiagram1.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{FuzzyConnectednessCollaborationDiagram1.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{VoronoiSegmentationClassDiagram1.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{VoronoiSegmentationCollaborationDiagram1.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{VoronoiSegmentationCollaborationDiagram2.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{FuzzyVoronoiCollaborationDiagram1.eps}
...
\begin{figure}
\center
\includegraphics[width=\0.8textwidth]{FuzzyVoronoiDeformableCollaborationDiagram1.eps}
