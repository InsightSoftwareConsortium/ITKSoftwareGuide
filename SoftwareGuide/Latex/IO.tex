...
intricacies. These classes are the \code{ImageIO} classes. The delegation
mechanism allows to extend the number of supported file formats by just adding
new classes to the \code{ImageIO} hierarchy.
...
specific \code{ImageIO} instance that will be returned to the
\code{ImageFileReader}.
