...
This book is a guide to developing software with ITK. It covers building and
...
%% It seems this sentence would be more appropriate further in the text
%% because the level of detail goes beyond what's expected in an abstract.
%% There's a section in the introduction that talks about the examples.
