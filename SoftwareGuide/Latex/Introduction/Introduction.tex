...
parameters, and the knowledge of the many ITK community members
(see Section~\ref{sec:AdditionalResources} on page~\pageref{sec:AdditionalResources}).
...
\begin{itemize}
        ...
        OpenCV\footnote{\url{https://opencv.org}} and
        VTK\footnote{\url{https://www.vtk.org}}.
