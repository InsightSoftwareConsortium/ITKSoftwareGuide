...
orthogonality will be preserved after the transformation. 
...
$(1.0+ \epsilon)$ is quite different from $(5.0+\epsilon)$.
...
subject to the same vulnerabilities as the ScaleTransform.
