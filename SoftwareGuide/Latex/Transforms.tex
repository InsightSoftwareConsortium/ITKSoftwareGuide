...
Kernel Transforms are a set of Transform also suitable for performing
deformable registration. These transform compute on the fly the displacemente
...
differ on the type of interpolation kernel that is used when computing the the
