...
middle.  Rotational miss-registrations however usually exist as rotaions around
the center of the image, or at least as rotaions around a point in the middle
of the anatomical structure captured by the image. Attempting to solve this
non-origin rotations using rotation around the origin are an almost imposible
problem to solve with gradient descent optimizers since the deep basin of the
real solution is across a high ridge in the topography of the cost function.
