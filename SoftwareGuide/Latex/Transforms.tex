...
The main difference between this transform and the Euler2DTransform
...
The \doxygen{Similarity2DTransform} preserves angles. It
...
characteristics of the ScaleTransform and Euler2DTransform relating to the 
non-linearity of the parameter
...
same concerns as the Similarity2DTransform when used with gradient descent optimizers.
...
QuaternionRigidTransform. It can be seen as a VersorTransform plus a translation defined by a vector. In general
terms, it implements a rigid transform in $3D$.  The advantage of this class
with respect to the QuaternionRigidTransform is that it exposes
only six parameters, three for the versor components and three for the
translational components. This reduces the search space for the optimizer 
to six dimensions instead of the seven dimensional used by the 
QuaternionRigidTransform. The main features of this transform
...
functionality offered by the optimizer for rescaling the parameter space. This is
