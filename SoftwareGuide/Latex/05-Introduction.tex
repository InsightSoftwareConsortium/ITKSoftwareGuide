...
open-source CDash regression testing system
...
\ref{sec:CDash} on page \pageref{sec:CDash}.)
...
Please read the
\code{GettingStarted.txt}\footnote{http://www.itk.org/Wiki/ITK/Getting\_Started}
...
\code{IITK}.  Any time you want to update your version, it will be enough to
...
\begin{itemize}
        ...
        source code. For example, CTest and Doxygen support, as well as
...
the \code{InsightApplications} module is also available via Git using the
