...
major components of the registration framework in ITK when model base
...
in a \doxygen{SpatialObject}. A Metrics has to be defined in order to evaluate
...
\doxygen{SpatialObject} and by changing its internal parameters. The search
...
ITK provides a hierarchy of classed intended to support the construction of
