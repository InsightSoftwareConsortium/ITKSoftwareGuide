...
another}.
\item Maintain a clean shape of history (see
Section~\ref{subsubsec:HistoryShape} on page~\pageref{HistoryShape}).
\end{itemize}
...
\label{subsubsubsec:InitialSetup}
...
\subsubsubsection{New Topic}
\label{subsubsubsec:NewTopic}
...
Section~\ref{subsubsubsec:NamingTopics} on
page~\pageref{subsubsubsec:NamingTopics}).
...
During this step, avoid the \ref{subsubsubsec:UrgeToMerge} from an integration
branch. Keep your commits focused on the topic at hand.
...
See Section~\ref{subsubsubsec:MultipleIntegrationBranches} on
page~\pageref{subsubsubsec:MultipleIntegrationBranches} to resolve any conflict
...
See Section~\ref{subsubsubsec:RemoteEndHungUpUnexpectedly} on
page~\pageref{subsubsubsec:RemoteEndHungUpUnexpectedly} and
Section~\ref{subsubsubsec:NonFastForward} on
page~\pageref{subsubsubsec:NonFastForward} to resolve any conflict that may
arise when publishing the change.


\subsubsubsection{Mature Topic}
\label{subsubsubsec:MatureTopic}
...
See Section~\ref{subsubsubsec:MultipleIntregrationBranches} on
page~\pageref{subsubsubsec:MultipleIntregrationBranches} to resolve any conflict that may
...
\subsubsubsection{Old Topic}
\label{subsubsubsec:OldTopic}
...
\subsubsubsection{Dependent Topic}
\label{subsubsubsec:DependentTopic}
...
Section~\ref{subsubsubsec:LegitimateMerges} on
page~\pageref{subsubsubsec:LegitimateMerges}). Do not merge an integration
branch that has the \textit{other-topic} branch name. Use the instructions
below to merge only the \textit{other-topic} branch without getting
everything else.
...
\subsubsubsection{Merge Integration Branches}
\label{subsubsubsec:MergeIntegrationBranches}

Each published integration branch (see Section~\ref{subsubsec:PublishedBranches}
on page~\pageref{subsubsec:subsubsec:PublishedBranches}) has a defined level of
...
\label{subsubsubsubsec:Discussion}

\subsubsubsection{History Shape}
\label{subsubsubsec:HistoryShape}
...
\subsubsubsection{Naming Topics}
\label{subsubsubsec:NamingTopics}
...
described in Section~\ref{subsubsubsec:HistoryShape} will show only these merge
commits, so their messages should be descriptive of the changes made on their
topics. If you did not choose a good branch name, or feel that the merge needs
more explanation than the branch name provides, amend the commit to update the
message by hand:
...
\subsubsubsection{Urge to Merge}
\label{subsubsubsec:UrgeToMerge}
...
\subsubsubsection{Habitual Merges}
\label{subsubsubsec:HabitualMerges}
...
the shape of history (see  Section~\ref{subsubsubsec:HistoryShape} on
page~\pageref{subsubsubsec:HistoryShape}).
...
\subsubsubsection{Legitimate Merges}
\label{subsubsubsec:LegitimateMerges}

One reason to merge other work into your topic is when you realize that your
topic depends on it. See Section~\ref{subsubsubsec:DependentTopic} on
page~\pageref{subsubsubsec:DependentTopic} for help with this case.
...
\subsubsubsection{Trouble Merging}
\label{subsubsubsec:TroubleMerging}

%TODO: Write this sub-section and link sub-sub-sections from git merge commands above.

\subsubsubsection{Trouble Pushing}
\label{subsubsubsec:TroublePushing}

\subsubsubsubsection{Remote End Hung up Unexpectedly}
\label{subsubsubsubsec:RemoteEndHungUpUnexpectedly}
...
\subsubsubsubsection{Non-Fast-Forward}
\label{subsubsubsubsec:Non-Fast-Forward}
...
Section~\ref{subsubsubsec:HistoryShape} on
page~\pageref{subsubsubsec:HistoryShape}).
...
\subsubsubsubsection{First-Parent Sequence Not Preserved}
\label{subsubsubsubsec:First-ParentSequenceNotPreserved}

One goal of this workflow is to preserve a clean shape of history (see
Section~\ref{subsubsubsec:HistoryShape} on
page~\pageref{subsubsubsec:HistoryShape}). This means that a
\code{--first-parent} traversal of an integration branch, such as
...
Rejected as \textit{non-fast-forward} (see
Section~\ref{subsubsubsec:NonFastForward} on
page~\pageref{subsubsubsec:NonFastForward}).
...
Section~\ref{subsubsubsec:FirstParentSequenceNotPreserved} on
page~\pageref{subsubsubsec:FirstParentSequenceNotPreserved}).
...
\subsubsubsubsection{Topics Must Be Merged}
\label{subsubsubsubsec:TopicsMustBeMerged}
...
\subsubsubsection{Single Integration Branch}
\label{subsubsubsec:SingleIntegrationBranch}
...
\subsubsubsubsection{Topic-to-Single-Branch}
\label{subsubsubsubsec:TopicToSingleBranch}
...
This approach does not work when using a topic stage (see
Section~\ref{subsec:Stage} on page~\pageref{subsec:Stage}). It cannot resolve
the conflicts automatically and may print instructions to follow
the~\ref{subsubsubsubsec:BranchToTopic} approach.

\subsubsubsubsection{Branch-to-Topic}
\label{subsubsubsubsec:BranchToTopic}
...
Our topic stages (see Section~\ref{subsec:Stage} on page~\pageref{subsec:Stage})
use this approach when working with a single integration branch.


\subsubsubsection{Multiple Integration Branches}
\label{subsubsubsec:MultipleIntegrationBranches}
...
\begin{itemize}
\item Merge the topic to the branch (see
Section~\ref{subsubsubsubsec:TopicToBranch}).
\item Merge one topic into the other (see
Section~\ref{subsubsubsubsec:TopicToTopic}).
\item Merge both topics into a resolution topic (see
Section~\ref{subsubsubsubsec:ResolutionTopic}).
\end{itemize}
...
\subsubsubsubsection{Topic-to-Branch}
\label{subsubsubsubsec:TopicToBranch}
...
This approach works with manual merging but requires care. It does not work when
using a topic stage (see Section~\ref{subsec:Stage} on
page~\pageref{subsec:Stage})) that cannot resolve the conflicts automatically
and may print instructions to follow the~\ref{subsubsubsubsec:TopicToTopic} approach..


\subsubsubsubsection{Topic-to-Topic}
\label{subsubsubsubsec:TopicToTopic}
...
Section~\ref{subsubsubsec:DependentTopic} on page~\pageref{subsubsubsec:page})
introduced by the conflict resolution commit. See
the~\ref{subsubsubsubsec:ResolutionTopic} approach to avoid this problem.


\subsubsubsubsection{Resolution Topic}
\label{subsubsubsubsec:ResolutionTopic}

The~\ref{subsubsubsubsec:TopicToTopic} approach introduces an artificial topic
...
As in the~\ref{subsubsubsubsec:TopicToBranch} approach, an attempt to merge
...
\label{subsubsubsec:Authentication}
...
\subsubsubsubsection{SSH on Windows}
\label{subsubsubsubsec:SSHOnWindows}
...
\subsubsubsubsection{AuthenticationTest}
\label{subsubsubsubsec:AuthenticationTest}
...
\subsubsubsection{Pushing}
\label{subsubsubsubsec:Pushing}
...
In order to publish new commits in a \ref{public.kitware.com} repository,
...
\subsubsubsection{Creating Patches}
\label{subsubsubsec:CreatingPatches}
...
\subsubsubsection{Sending Patches}
\label{subsubsubsec:SendingPatches}
...
\subsubsubsection{Applying Patches}
\label{subsubsubsec:ApplyingPatches}
...
Section~\ref{subsubsubsec:Update} on page~\pageref{subsubsubsec:Update}) on the
commits it accepts and will reject non-conforming commits. In order to push
rejected commits, one must edit history locally to repair them before
publishing.
...
\subsubsubsection{Local Pull}
\label{subsubsubsec:LocalPull}
...
\subsubsubsection{Direct Pull}
\label{subsubsubsec:DirectPull}
...
\subsubsubsection{pre-commit}
\label{subsubsubsec:pre-commit}
...
\subsubsubsection{commit-msg}
\label{subsubsubsec:commit-msg}
...
\subsubsubsection{Bash Completion}
\label{subsubsubsec:BashCompletion}
...
\subsubsubsection{Bash Prompt}
\label{subsubsubsec:BashPrompt}
...
\subsubsubsection{Renaming}
\label{subsubsubsec:Renaming}
