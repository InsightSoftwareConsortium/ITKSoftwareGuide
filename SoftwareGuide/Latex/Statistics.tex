...
class derived from \doxygen{FixedArray}, includeing \doxygen{FixedArray}
itself.

\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{SampleInheritanceTree.eps}
  \itkcaption{Sample class inheritance tree}
...
\label{sec:SampleStatistics}
 ...
 from a sample (\subdoxygen{Statistics}{Sample}) classes. Statistics can
...
\begin{figure}[h]
  ...
  \itkcaption{Simple conceptual classifier}
  \label{fig:simple}
\end{figure}
...
\begin{figure}
  ...
  \itkcaption{ITK Statistical classification framework}
